    ...
    <div class="grid gap-10 md:grid-cols-10">
        <div class="md:col-span-7">
            ...
            <div class="grid gap-5">
                @forelse ($items as $item)
                    <div class="flex items-center gap-5 pb-5 border-b border-gray-200">
                        <div class="relative w-40 h-40 overflow-hidden rounded-xl">
                            <img class="object-coversize-full" src="{{ $item->product()->cover }}"
                        ...
                        <div class="flex items-center">
                            <div class="py-5">
                                ...
                                <h2 class="text-sm text-gray-800">{{ $item->product()->tag }}</h2>
                ...
                @empty
                    <div class="p-5 text-center border border-gray-200 rounded-lg">
                        Your cart is empty.
                    </div>
                @endforelse
            </div>
